...
//import java.io.*;
    ...
    public static class WavFile {
        ...
        public float getPosition(int increment) {
            return (frameCounter + increment) / (float)sampleRate;
        }
...
// Instantiate new Wavfile and initialise
            ...
            wavFile.duration = numFrames / sampleRate;
...
// Calculate the duration in seconds
                    wavFile.duration = wavFile.numFrames / wavFile.sampleRate;
...
//            System.out.println("FrameCounter : " + frameCounter);
            return numFramesToRead;// - (int)(long)numFrames;
        }
